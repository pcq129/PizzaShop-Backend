...
class CustomerExports implements
    FromCollection,
    WithHeadings,
    WithStyles,
    WithEvents,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('C7', $this->filters[0] .'-'. $this->filters[1]);
                ...
                // $sheet->setCellValue('E7', $this->filters[2]);
                $sheet->setCellValue('D7', 'Account: ')->getStyle('D7')->applyFromArray([
                    'font' => ['bold' => true, 'color' => ['argb' => 'FFFFFFFF']],
                    'fill' => [
                        'fillType' => Fill::FILL_SOLID,
                        'startColor' => ['argb' => 'FF0070c0'],
                ...
                $sheet->setCellValue('E9', $this->filters[2]);
                $sheet->setCellValue('D9', 'Search: ')->getStyle('D9')->applyFromArray([
                    'font' => ['bold' => true, 'color' => ['argb' => 'FFFFFFFF']],
                    'fill' => [
                        'fillType' => Fill::FILL_SOLID,
                        'startColor' => ['argb' => 'FF0070c0'],
                ...
                $sheet->setCellValue('C9',$this->filters[3]);
                ...
                $sheet->mergeCells('D2:D5')->setCellValue('D2', 'Customers')->getStyle('D2')->applyFromArray([
                    'font' => [
                        'bold' => true,
                        'color' => ['argb' => 'FF0070c0'],
                        'size' => 20,
